...
namespace boost { namespace numeric { namespace ublas {
    ...
    public:
        ...
        // Construction and destruction
        BOOST_UBLAS_INLINE
        general_product (const matrix_expression<expression1_type>& e1, const matrix_expression<expression2_type>& e2) : e1_ (e1), e2_ (e2) { }
...
#ifndef BOOST_UBLAS_USE_INDEXED_ITERATOR
        class const_iterator1:
        public container_const_reference<general_product>,
        public iterator_base_traits<typename iterator_restrict_traits<typename E1::const_iterator1::iterator_category,
        typename E2::const_iterator2::iterator_category>::iterator_category>::template
        iterator_base<const_iterator1, value_type>::type {
        public:
            typedef typename iterator_restrict_traits<typename E1::const_iterator1::iterator_category,
            typename E2::const_iterator2::iterator_category>::iterator_category iterator_category;
            typedef typename general_product::difference_type difference_type;
            typedef typename general_product::value_type value_type;
            typedef typename general_product::const_reference reference;
            typedef typename general_product::const_pointer pointer;
