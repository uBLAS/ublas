...
inline void sminit(size_t N, blaze::CompressedMatrix<double>& data, double filling = 0.25) {
...
inline void sminit_Snormal(size_t N, blaze::CompressedMatrix<double>& data, double filling = 0.25) { //default quarter filled
