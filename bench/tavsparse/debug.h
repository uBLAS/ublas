...
Contact: http://www.volya.net 
Date: Tue Feb  7 21:22:16 UTC 2012
Research and development version, not for public distribution.
*/
/*! \file debug.h 
...
#define DBGMessage(message) std::cerr << message   <<std::endl<< __FILE__ << ":" << __LINE__ << std::endl
