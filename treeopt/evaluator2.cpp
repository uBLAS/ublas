...
public:
    ...
    static ReturnType build(const MatXpr& mxpr) { // std::cout << "1" << std::endl;
        return mxpr;
    }
};
...
public:
    ...
    static const ReturnType& build(const Dense_Matrix<rows, cols>& mxpr) { //std::cout << "2" << std::endl;
        return mxpr;
    }
...
public:
    ...
    static ReturnType build(const MatXpr& mxpr) { //std::cout << "3" << std::endl;
...
public:
    ...
    static ReturnType build(const MatXpr& mxpr) { //std::cout << "4" << std::endl;
        return Tree_Optimizer<A>::build(mxpr.matrixl) - Tree_Optimizer<B>::build(mxpr.matrixr);
    }
};
...
public:
    ...
    static ReturnType build(const MatXpr& mxpr) { //std::cout << "5" << std::endl;
        return Tree_Optimizer<A>::build(mxpr.matrixl) * Tree_Optimizer<B>::build(mxpr.matrixr);
    }
...
public:
    ...
    static ReturnType build(const MatXpr& mxpr) { //std::cout << "6" << std::endl;
...
public:
    ...
    static ReturnType build(const MatXpr& mxpr) { //std::cout << "7" << std::endl;
...
public:
    ...
    static ReturnType build(const MatXpr& mxpr) { std::cout << "8" << std::endl;
...
public:
    ...
    static ReturnType build(const MatXpr& mxpr) { //std::cout << "9" << std::endl;
...
public:
    ...
    static ReturnType build(const MatXpr& mxpr) { //std::cout << "10" << std::endl;
        return (Tree_Optimizer<C>::build(mxpr.matrixl.matrixl) - Tree_Optimizer<D>::build(mxpr.matrixr)) + mxpr.matrixl.matrixr;
    }
...
public:
    ...
    static ReturnType build(const MatXpr& mxpr) { //std::cout << "11" << std::endl;
        return Tree_Optimizer<C>::build(mxpr.matrixl.matrixl) + Tree_Optimizer<D>::build(mxpr.matrixr) - mxpr.matrixl.matrixr;
    }
...
public:
    ...
    static ReturnType build(const MatXpr& mxpr) { //std::cout << "12" << std::endl;
...
public:
    enum {
        treechanges = 0 //Tree_Optimizer<A>::treechanges || Tree_Optimizer<B>::treechanges || Tree_Optimizer<C>::treechanges || Tree_Optimizer<D>::treechanges,
    };
    ...
    typedef typename Tree_Optimizer<C>::ReturnType NMatC;
    typedef typename Tree_Optimizer<D>::ReturnType NMatD;
    typedef Matrix_Sum< Matrix_Product<NMatA, NMatB>, Matrix_Product<NMatC, NMatD> > ReturnType; // Tree_Optimizer<Matrix_Product<A, B>>::build(mxpr.matrixl.matrixl)
...
int main(){
    ...
    std::cout << Tree_Optimizer<decltype(A * B + C)>::treechanges << " " << Tree_Optimizer<decltype(C + A * B)>::treechanges << "\n\n";
    ...
    std::cout << Tree_Optimizer<decltype(A * B + C + D)>::treechanges << " " << Tree_Optimizer<decltype(D + A * B + C)>::treechanges << " " << Tree_Optimizer<decltype(C + D + A * B)>::treechanges << "\n\n";
    ...
    std::cout << "\n" << "changes? " << "\n";
    std::cout << Tree_Optimizer<decltype(A * B + C - D)>::treechanges << " " << Tree_Optimizer<decltype(C + A * B - D)>::treechanges << " " << Tree_Optimizer<decltype(C - D + A * B)>::treechanges << "\n\n";
    ...
    std::cout << "\n" << "changes? " << "\n";
    std::cout << Tree_Optimizer<decltype(A * B * C)>::treechanges << " " << Tree_Optimizer<decltype(A * (B * C))>::treechanges << "\n\n";
    ...
    typedef expression_types1< 10, decltype(mxpr), decltype(mxpr) >::type test5;
    ...
    std::cout << "\n" << "changes? " << "\n";
    std::cout << Tree_Optimizer<decltype(mxpr)>::treechanges << " " << Tree_Optimizer<decltype(result8)>::treechanges << "\n\n";
    
    std::cout << "before name: " << result8.name() << "\n";
    Tree_Optimizer<decltype(result8)>::ReturnType tresult = Tree_Optimizer<decltype(result8)>::build(result8);
    std::cout << "after name: " << tresult.name() << "\n";
